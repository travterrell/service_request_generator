<div id="view_request">
	...
	<div class="row" id="request_main_info" data-request_id="">
		<div class="col-sm-6 main_project_info_columns">
			<p id="request_id">1<p>
			<h4 class="blue request_h4">Agency:</h4>
			<img id="request_agency_logo" src="" height="110px" width="110px">
		  	<h4 id="request_agency_name">Agency Name</h4>
		</div>

		<div class="col-sm-6 main_project_info_columns" id="project_info_section">
			<h3 class="blue request_h4" id="request_project_name">Project Name</h3>
		  	<h4><span class="blue">Created Date:</span> <span id="request_created_date">Insert Date</span></h4>
		  	<h4><span class="blue">Budget:</span> <span id="request_budget">Insert Budget</h4>
		  	<h4><span class="blue">Primary Sales Contact:</span> <span id="request_primary_sales_contact">Name</span></h4>
		  	<h4><span class="blue">Customer Contact:</span> <span id="request_customer_contact">Name</span></h4>
		</div>
	</div>

	<div class="row" id="request_service_info">
		<div class="col-sm-12">
			<h4 class="blue">Is the supplier already working with customers?</h4>
		  	<h4 id="request_customers">Yes</h4>
		  	<h4 class="blue">Where are the corps headquarters located?</h4>
		  	<h4 id="request_hq_location">San Jose, CA</h4>
		  	<h4 class="blue">Will contract be executed by outside US entity?</h4>
		  	<h4 id="request_outside_entity">No</h4>
		  	<h4 class="blue">Is foreign currency payment a requirement at any of the locations?</h4>
		  	<h4 id="request_foreign_currency">Yes</h4>
		  	<h4 class="blue">Do you have a network diagram available of current and desired solution?</h4>
		  	<h4 id="request_network_diagram">Yes</h4>
		  	<h4 class="blue">Is a backup and/or diverse connection required?</h4>
		  	<h4 id="request_backup_diverse">No</h4>
		  	<h4 class="blue">Do you require any Voice (SIP/TDM) to be deployed with this solution?</h4>
		  	<h4 id="request_voice">Yes</h4>
		</div>
	</div>

	<div class="row" id="view_request_exports" data-request_id="">
	    <div class="col-sm-6">
	      <svg class="export word"
	...
	<div class="row" id="request_links">
		<div class="col-sm-6">
		  <a id="edit_request">Edit Request</a>
		</div>

		<div class="col-sm-6">
		  <a id="create_new_request">Create New Request</a>
		</div>
	</div>
